...
55. **UI Fix Frecce Spinner** (10/07/2026): Aggiunto CSS globale in `index.css` per rendere le frecce spinner degli input `type=number` visibili nel dark theme (`color-scheme: dark` + `filter: invert(1) brightness(1.2)`). Le frecce ora sono chiare e leggibili nel Calcolatore.
